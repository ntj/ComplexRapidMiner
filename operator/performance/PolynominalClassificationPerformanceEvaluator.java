 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: PolynominalClassificationPerformanceEvaluator.java,v 1.7 2008/05/09 19:22:43 ingomierswa Exp $
 */
public class PolynominalClassificationPerformanceEvaluator extends AbstractPerformanceEvaluator {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeList(PARAMETER_CLASS_WEIGHTS, "The weights for all classes (first column: class name, second column: weight), empty: using 1 for all classes.", new ParameterTypeDouble("weight", "The weight for the specified class.", 0.0d, Double.POSITIVE_INFINITY, 1.0d)));
		return types;
	}
}
