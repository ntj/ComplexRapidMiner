 ...
 * @version $Id: LogarithmicLoss.java,v 1.4 2008/09/12 10:30:45 tobiasmalbrecht Exp $
 */
public class LogarithmicLoss extends AbstractBregmanDivergence {

	public LogarithmicLoss(ExampleSet es) throws InstantiationException {
		super(es);
	}
	...
	public double distance(Example x, double[] y) {
		...
		result = (xValue * Math.log(xValue / y[0])) - (xValue - y[0]);
		return result;
	}
