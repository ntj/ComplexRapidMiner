 ...
 * @version $Id: AssociationRuleGenerator.java,v 1.10 2008/08/21 13:17:07 ingomierswa Exp $
 */
public class AssociationRuleGenerator extends Operator {
	...
	public List<ParameterType> getParameterTypes() {
		...
		type.setExpert(false);
		type.registerDependencyCondition(new EqualTypeCondition(this, PARAMETER_CRITERION, true, CONFIDENCE));
		types.add(type);
		...
		type.setExpert(false);
		type.registerDependencyCondition(new EqualTypeCondition(this, PARAMETER_CRITERION, true, LIFT, CONVICTION, PS, GAIN, LAPLACE));
		types.add(type);
