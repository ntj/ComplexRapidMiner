 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: RelativeRegressionModel.java,v 1.1 2008/06/09 15:26:54 ingomierswa Exp $
 */
public class RelativeRegressionModel extends PredictionModel {
	...
	public Component getVisualizationComponent(IOContainer container) {
		return baseModel.getVisualizationComponent(container);
	}
}
