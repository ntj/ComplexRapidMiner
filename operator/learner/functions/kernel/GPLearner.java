 ...
 *  @version $Id: GPLearner.java,v 1.8 2008/05/09 19:23:01 ingomierswa Exp $
 *  @rapidminer.index GP
 */
...
//   				}
    ...
    public List<ParameterType> getParameterTypes() {
    	...
    	//type = new ParameterTypeCategory(PARAMETER_GP_TYPE, "Regression", GP_TYPES, 0);
    	...
    	type = new ParameterTypeDouble(PARAMETER_KERNEL_LENGTHSCALE, "The lengthscale r for rbf kernel functions (exp{-1.0 * r^-2 * ||x - bla||}).", 0, Double.POSITIVE_INFINITY, 3.0);
    	type.setExpert(false);
    	types.add(type);
