...
/**
 * This class represents the single link cluster similarity.
 * 
 * @author Michael Wurst
 * @version $Id: SingleLink.java,v 1.5 2008/09/12 10:32:10 tobiasmalbrecht Exp $
 */
public class SingleLink implements ClusterSimilarity {

	public double similarity(double x1y, double x2y, ClusterNode cx1, ClusterNode cx2, ClusterNode cy) {
		return Math.max(x1y, x2y);
	}
}
