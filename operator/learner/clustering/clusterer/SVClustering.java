 ...
 * @version $Id: SVClustering.java,v 1.9 2008/09/12 10:31:40 tobiasmalbrecht Exp $
 */
public class SVClustering implements SVMInterface {
	...
	public SVClustering(Operator paramOperator, Kernel new_kernel, SVCExampleSet new_examples) throws UndefinedParameterError {
		...
		C = 1.0 / (examples_total * paramOperator.getParameterAsDouble(SVClusteringOperator.PARAMETER_P));
	};
