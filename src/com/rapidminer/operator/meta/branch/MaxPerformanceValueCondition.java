 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: MaxPerformanceValueCondition.java,v 1.2 2008/05/09 19:23:21 ingomierswa Exp $
 */
public class MaxPerformanceValueCondition implements ProcessBranchCondition {
	...
	public boolean check(ProcessBranch operator, String value) throws OperatorException {
		...
		PerformanceVector performance = operator.getInput().get(PerformanceVector.class);
