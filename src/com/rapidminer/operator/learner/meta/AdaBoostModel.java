 ...
 * @version $Id: AdaBoostModel.java,v 1.3 2007/07/13 22:52:12 ingomierswa Exp $
 */
public class AdaBoostModel extends PredictionModel {
	 ...
	 */
	public void performPrediction(ExampleSet origExampleSet, Attribute predictedLabel)
		throws OperatorException
	{
		...
		for (int modelNr = 0; modelNr < this.getNumberOfModels(); modelNr++) {
			...
			final ExampleSet exampleSet = (ExampleSet) origExampleSet.clone();
