 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: GenericWekaMetaLearner.java,v 1.22 2006/04/05 09:42:02
 *          ingomierswa Exp $
 */
public class GenericWekaMetaLearner extends OperatorChain implements Learner, TechnicalInformationHandler {
	...
	private String[] getWekaParameters() throws OperatorException {
		String[] parameters = WekaTools.getWekaParametersFromTypes(this, wekaParameters);
	...
	public boolean supportsCapability(LearnerCapability capability) {
		try {
			Classifier classifier = getWekaClassifier(getWekaParameters());
	...
	public List<ParameterType> getParameterTypes() {
		...
		if (classifier != null) {
		    WekaTools.addParameterTypes(classifier, types, wekaParameters, true, "W");
		}
		return types;
	}
}
