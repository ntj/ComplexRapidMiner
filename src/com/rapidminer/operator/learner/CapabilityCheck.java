 ...
 *
 * @author Ingo Mierswa
 * @version $Id: CapabilityCheck.java,v 1.1 2007/06/16 14:13:27 ingomierswa Exp $
 */
	...
	public void checkLearnerCapabilities(Operator learningOperator, ExampleSet exampleSet) throws OperatorException {
		try {
			...
			if (exampleSet.getAttributes().getLabel().isNominal()) {
				...
				if (!exampleSet.getAttributes().getLabel().isNominal() && !learner.supportsCapability(LearnerCapability.NUMERICAL_CLASS))
