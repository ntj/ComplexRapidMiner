 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: ClassificationEvoOptimization.java,v 1.5 2007/07/14 12:31:38 ingomierswa Exp $
 */
public class ClassificationEvoOptimization extends ESOptimization implements EvoOptimization {
	...
	public EvoSVMModel train() throws OperatorException {
        ...
        if (holdOutSet != null) {
        	...
        	// print max alphas
        	//Collections.sort(maxAlphas);
        	//System.out.println("min C: " + Collections.min(maxAlphas));
        	//System.out.println("max C: " + Collections.max(maxAlphas));
        	//System.out.println("All max alphas (C): " + maxAlphas);
