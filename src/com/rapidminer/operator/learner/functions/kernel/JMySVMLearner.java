 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: JMySVMLearner.java,v 1.11 2008/05/09 19:23:01 ingomierswa Exp $
 */
public class JMySVMLearner extends AbstractMySVMLearner {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeBoolean(PARAMETER_ESTIMATE_PERFORMANCE, "Indicates if this learner should also return a performance estimation.", false));
