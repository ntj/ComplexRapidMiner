 ...
 * with the same name of the {@link com.rapidminer.operator.ProcessRootOperator} 
 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: ResultWriter.java,v 1.4 2007/06/23 00:09:30 ingomierswa Exp $
 */
public class ResultWriter extends Operator {
	...
	public IOObject[] apply() throws OperatorException {
		IOObject[] input = getInput().getIOObjects();
        File file = getParameterAsFile(PARAMETER_RESULT_FILE);
        if (file != null) {
            PrintWriter out = null;
            try {
                if (firstRun) {
                    out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(file, false), getEncoding()));
                } else {
                    out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(file, true), getEncoding()));
                }
                firstRun = false;
            } catch (IOException e) {
