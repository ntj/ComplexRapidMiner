 ...
 *          Exp $
 */
public abstract class AbstractStratifiedSampling extends Operator {
	...
	public IOObject[] apply() throws OperatorException {
		...
		SplittedExampleSet splittedExampleSet = new SplittedExampleSet(exampleSet, getRatio(exampleSet), SplittedExampleSet.STRATIFIED_SAMPLING, getParameterAsInt(PARAMETER_LOCAL_RANDOM_SEED));
