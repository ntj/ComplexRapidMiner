 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: IOConsumeOperator.java,v 1.13 2006/03/27 13:21:58 ingomierswa
 *          Exp $
 */
		...
		if (clazz != null) {
			switch (getParameterAsInt(PARAMETER_DELETION_TYPE)) {
				case DELETE_ONE:
					...
					getInput(clazz, (number - 1));
					log("Deleted " + number + ". " + clazz.getName() + ".");
					break;
				case DELETE_ALL:
					int counter = 0;
					try {
						...
						log("Deleted " + counter + " " + clazz.getName() + ".");
					}
					break;
				case DELETE_ALL_BUT:
					counter = 0;
					...
					log("Deleted " + counter + " input objects.");
					break;
