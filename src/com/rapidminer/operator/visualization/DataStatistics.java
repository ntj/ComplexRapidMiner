 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: DataStatistics.java,v 1.2 2007/07/10 18:02:02 ingomierswa Exp $
 */
public class DataStatistics extends ResultObjectAdapter {
	...
	public void addInfo(ExampleSet exampleSet, Attribute attribute) {
        ...
        if (attribute.isNominal()) {
            ...
            result.append("avg = " + exampleSet.getStatistics(attribute, Statistics.AVERAGE) + " +/- " + exampleSet.getStatistics(attribute, Statistics.VARIANCE));
        }
