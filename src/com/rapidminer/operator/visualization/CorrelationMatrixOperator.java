...
public class CorrelationMatrixOperator extends Operator {
	...
	public Class[] getOutputClasses() {
		return getParameterAsBoolean(PARAMETER_CREATE_WEIGHTS) ? new Class[] { ExampleSet.class, AttributeWeights.class } : new Class[] { ExampleSet.class, CorrelationMatrix.class };
	}
