 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: SinusFactory.java,v 1.2 2007/07/10 18:02:03 ingomierswa Exp $
 */
public class SinusFactory {
	...
	public void generateSinusFunctions(ExampleSet exampleSet, List<AttributePeak> attributes, Random random) throws GenerationException {
		if (attributes.size() > 0) {
			...
			// System.out.println("### total max evidence: " +
			// totalMaxEvidence);
			...
			while (a.hasNext()) {
				...
				if (ae.getEvidence() > MIN_EVIDENCE * totalMaxEvidence) {
					// System.out.println("+ Construct: sin(" +
					// ae.getFrequency() + " * " +
					// ae.getAttribute().getName() + ") with evidence " +
					// ae.getEvidence());
