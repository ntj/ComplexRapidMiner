 ...
 * @version $Id: NoMissingAttributesCondition.java,v 2.2 2006/03/21 15:35:39
 *          ingomierswa Exp $
 */
public class NoMissingAttributesCondition implements Condition {
	...
	public NoMissingAttributesCondition(ExampleSet exampleSet, String parameterString) {
		if ((parameterString != null) && (parameterString.trim().length() != 0))
			throw new IllegalArgumentException("NoMissingAttributesCondition does not need any parameters!");
	}
