 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: NoMissingLabelsCondition.java,v 2.2 2006/03/21 15:35:39
 *          ingomierswa Exp $
 */
public class NoMissingLabelsCondition implements Condition {
	...
	public NoMissingLabelsCondition(ExampleSet exampleSet, String parameterString) {
		if ((parameterString != null) && (parameterString.trim().length() != 0))
			throw new IllegalArgumentException("NoMissingLabelsCondition does not need any parameters!");
	}
