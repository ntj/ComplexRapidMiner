 ...
 *  
 * @author Ingo Mierswa
 * @version $Id: Attributes.java,v 1.3 2008/05/09 19:22:42 ingomierswa Exp $
 */
public interface Attributes extends Iterable<Attribute>, Cloneable, Serializable {
	...
	public static final String[] KNOWN_ATTRIBUTE_TYPES = new String[] { ATTRIBUTE_NAME, LABEL_NAME, ID_NAME, WEIGHT_NAME, BATCH_NAME, CLUSTER_NAME, PREDICTION_NAME, OUTLIER_NAME, CLASSIFICATION_COST };
