 ...
 * @version $Id: SampleTest.java,v 1.6 2007/06/16 16:35:17 ingomierswa Exp $
 */
public abstract class SampleTest extends TestCase {
	...
	public void sampleTest() throws Exception {
		File processFile = new File(ParameterService.getRapidMinerHome(), "sample" + File.separator + file);
	...
	public static Test suite() {
		...
		suite.addTest(new ExampleSetSampleTest("03_Preprocessing" + File.separator + "05_MinimalEntropyPartitioning.xml", 208, 22));
		...
		suite.addTest(new PerformanceSampleTest("04_Validation" + File.separator + "03_XValidation_Numerical.xml", new String[] { "correlation" }, new double[] { 0.999077 }));		suite.addTest(new PerformanceSampleTest("04_Validation" + File.separator + "04_XValidation_Nominal.xml", new String[] { "classification_error" }, new double[] { 0.275000 }));
