 ...
 * @version $Id: AttributeDataSource.java,v 2.22 2006/03/27 13:22:03 ingomierswa
 *          Exp $
 */
		...
		for (int i = 0; i < attributes.getLength(); i++) {
			...
			if (node instanceof Element) {
                ...
                if (Ontology.ATTRIBUTE_VALUE_TYPE.isA(valueType, Ontology.NOMINAL)) {
                    ...
                    // if list is still empty try deprecated 'classes' attribute
                    ...
                    if (classList.size() == 0) { // stil empty class list? --> Warning
