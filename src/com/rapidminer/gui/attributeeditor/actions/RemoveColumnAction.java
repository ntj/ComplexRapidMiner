 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: RemoveColumnAction.java,v 1.4 2008/05/09 19:23:19 ingomierswa Exp $
 */
public class RemoveColumnAction extends AbstractAction {
	...
	public RemoveColumnAction(AttributeEditor attributeEditor, IconSize size) {
		super("Remove column", ICONS[size.ordinal()]);
