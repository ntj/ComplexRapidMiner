 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: CloseAction.java,v 1.4 2008/05/09 19:23:19 ingomierswa Exp $
 */
public class CloseAction extends AbstractAction {
    ...
    public CloseAction(AttributeEditorDialog attributeEditorDialog, IconSize size) {
        super("Close", ICONS[size.ordinal()]);
        putValue(SHORT_DESCRIPTION, "Closes the Attribute Editor dialog");
