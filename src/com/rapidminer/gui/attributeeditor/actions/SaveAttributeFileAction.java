 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: SaveAttributeFileAction.java,v 1.4 2008/05/09 19:23:19 ingomierswa Exp $
 */
public class SaveAttributeFileAction extends AbstractAction {
	...
	public SaveAttributeFileAction(AttributeEditor attributeEditor, IconSize size) {
		super("Save Attribute Description File...", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Save current attribute meta data descriptions into an XML file (.aml)");
