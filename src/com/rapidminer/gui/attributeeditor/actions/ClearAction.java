 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: ClearAction.java,v 1.4 2008/05/09 19:23:19 ingomierswa Exp $
 */
public class ClearAction extends AbstractAction {
	...
	public ClearAction(AttributeEditor attributeEditor, IconSize size) {
		super("Clear", ICONS[size.ordinal()]);
