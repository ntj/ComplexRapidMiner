 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: PerformanceVectorViewer.java,v 1.3 2008/05/09 19:23:01 ingomierswa Exp $
 */
public class PerformanceVectorViewer extends JPanel {
	...
	public PerformanceVectorViewer(final PerformanceVector performanceVector, final IOContainer container) {
		...
		for (int i = 0; i < performanceVector.getSize(); i++) {
			...
			Component component = criterion.getVisualizationComponent(container);
			mainPanel.add(new ExtendedJScrollPane(component), criterion.getName());
		}
