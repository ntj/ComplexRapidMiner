...
public class AssociationRulesGraphCreator extends GraphCreatorAdaptor implements AssociationRuleFilterListener {
	...
	private Map<String, String> toolTipInfos = new HashMap<String, String>();
	
	private List<String> nodeList = new LinkedList<String>();
	
	private List<String> edgeList = new LinkedList<String>();
	
	private Map<String, List<String>> asPremise = new HashMap<String, List<String>>();
	
	private Map<String, List<String>> asConclusion = new HashMap<String, List<String>>();
