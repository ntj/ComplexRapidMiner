 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: BasicPropertyTable.java,v 1.5 2008/07/13 16:39:42 ingomierswa Exp $
 */
public class BasicPropertyTable extends PropertyTable {
	...
	private class BasicPropertyModel extends AbstractTableModel {
		...
		public void setValueAt(Object value, int row, int column) {
			if (column == 1) {
				...
				parameters.setParameterWithoutCheck(key, value);
	...
	public void setValue(String key, Object value) {
		this.parameters.setParameterWithoutCheck(key, value);
		updateParameterTypes();
	}
