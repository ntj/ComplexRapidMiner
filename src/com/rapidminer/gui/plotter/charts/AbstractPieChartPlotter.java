 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: AbstractPieChartPlotter.java,v 1.1 2007/05/27 22:02:53 ingomierswa Exp $
 *
 */
public abstract class AbstractPieChartPlotter extends PlotterAdapter {
	...
	public abstract JFreeChart createChart(PieDataset pieDataSet);
		...
		synchronized (dataTable) {
			...
			if (valueColumn >= 0) {
				...
				while (c.hasNext()) {
					...
					pieDataSet.setValue(name, oldValue / counter);
				}
			}
		}
	}
