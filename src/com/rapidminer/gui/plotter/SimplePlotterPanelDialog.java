 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: SimplePlotterPanelDialog.java,v 1.2 2008/05/09 19:22:51 ingomierswa Exp $
 */
public class SimplePlotterPanelDialog extends JDialog {
	...
	public SimplePlotterPanelDialog(Frame owner, final DataTable dataTable, int width, int height, boolean modal) {
		...
		PlotterPanel plotterPanel = new PlotterPanel(dataTable, PlotterPanel.DATA_SET_PLOTTER_SELECTION);
