 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: CopyAction.java,v 1.4 2008/05/09 19:23:18 ingomierswa Exp $
 */
public class CopyAction extends ConditionalAction {

	private static final long serialVersionUID = -8660207503491642477L;
	...
	public CopyAction(OperatorTree operatorTree, IconSize size) {
		super("Copy", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Copy selected operator");
