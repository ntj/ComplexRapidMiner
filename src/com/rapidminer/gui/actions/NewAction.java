 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: NewAction.java,v 1.5 2008/05/09 19:22:46 ingomierswa Exp $
 */
public class NewAction extends AbstractAction {
	...
	public NewAction(MainFrame mainFrame, IconSize size) {
		super("New", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Create an empty process definition");
