 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: TutorialAction.java,v 1.4 2008/05/09 19:22:46 ingomierswa Exp $
 */
public class TutorialAction extends AbstractAction {
	...
	public TutorialAction(MainFrame mainFrame, IconSize size) {
		super("RapidMiner Tutorial...", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Starts the RapidMiner online tutorial");
