 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: WelcomeWizardAction.java,v 1.5 2008/05/09 19:22:46 ingomierswa Exp $
 */
public class WelcomeWizardAction extends AbstractAction {
	...
	public WelcomeWizardAction(MainFrame mainFrame) {
		super("Process Wizard", icon);
		putValue(SHORT_DESCRIPTION, "Start the Process Wizard");
		this.mainFrame = mainFrame;
	}

	public void actionPerformed(ActionEvent e) {
		this.mainFrame.changeMode(MainFrame.EDIT_MODE);
		new WizardDialog(mainFrame).setVisible(true);
	}
}
