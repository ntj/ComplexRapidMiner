 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: OpenAction.java,v 1.5 2008/05/09 19:22:46 ingomierswa Exp $
 */
public class OpenAction extends AbstractAction {
	...
	public OpenAction(MainFrame mainFrame, IconSize size) {
		super("Open...", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Open a process definition file");
