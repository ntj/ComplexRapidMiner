 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: PrintAction.java,v 1.5 2008/05/09 19:22:46 ingomierswa Exp $
 */
public class PrintAction extends AbstractAction {
	...
	public PrintAction(MainFrame mainFrame, IconSize size) {
		super("Print...", ICONS[size.ordinal()]);
		putValue(SHORT_DESCRIPTION, "Print the current process definition or results (depending on view mode)");
		putValue(MNEMONIC_KEY, Integer.valueOf(KeyEvent.VK_P));
		this.mainFrame = mainFrame;
	}

	public void actionPerformed(ActionEvent e) {
		this.mainFrame.print();
	}
}
