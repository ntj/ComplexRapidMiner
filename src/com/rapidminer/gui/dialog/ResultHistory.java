 ...
 * 
 * @author Ingo Mierswa
 * @version $Id: ResultHistory.java,v 1.1 2007/07/15 22:06:25 ingomierswa Exp $
 */
public class ResultHistory extends AbstractListModel {

	private static final long serialVersionUID = -3346913516615767439L;
	
	private List<ResultContainer> allResults = new LinkedList<ResultContainer>();
	
	public ResultHistory() {}
	
	public void addResults(String name, Operator root, IOContainer results) {
		allResults.add(new ResultContainer(name, root.cloneOperator(root.getName()), results));
