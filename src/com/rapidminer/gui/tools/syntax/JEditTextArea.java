 ...
 * ta.setText(&quot;public class Test {&quot; + &quot;    public static void main(String[] args) {&quot; + &quot;        System.out.println(\&quot;Hello World\&quot;);&quot; + &quot;    }&quot; + &quot;}&quot;);
 * </pre>
 * 
 * @author Slava Pestov, Ingo Mierswa
 * @version $Id: JEditTextArea.java,v 1.3 2007/06/15 16:58:39 ingomierswa Exp $
 */
public class JEditTextArea extends JComponent implements MouseWheelListener {
	...
	private class DeleteAction extends AbstractAction {
		...
		private DeleteAction() {
			super("Delete");
			putValue(SHORT_DESCRIPTION, "Deletes the currently selected text");
	...
	private class ClearAllAction extends AbstractAction {
		...
		private static final long serialVersionUID = 8117327291650503260L;

		private ClearAllAction() {
			super("Clear All");
			putValue(SHORT_DESCRIPTION, "Deletes the complete text");
	...
	public final Action DELETE_ACTION = new DeleteAction();
	public final Action CLEAR_ALL_ACTION = new ClearAllAction();
	...
	private JPopupMenu createTextPopupMenu() {
		...
		menu.add(InputHandler.CLIP_CUT);
		menu.add(InputHandler.CLIP_COPY);
		menu.add(InputHandler.CLIP_PASTE);
		menu.add(DELETE_ACTION);
		menu.addSeparator();
		menu.add(CLEAR_ALL_ACTION);
		menu.add(InputHandler.SELECT_ALL);
		menu.addSeparator();
		menu.add(InputHandler.SEARCH_AND_REPLACE);
		return menu;
	}
