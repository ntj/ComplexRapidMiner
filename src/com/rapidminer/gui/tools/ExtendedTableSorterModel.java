 ...
 * 
 * @version $Id: ExtendedTableSorterModel.java,v 1.1 2008/08/25 08:10:36 ingomierswa Exp $
 */
public class ExtendedTableSorterModel extends AbstractTableModel {
    ...
    public ExtendedTableSorterModel() {
    	super();
    }

    public ExtendedTableSorterModel(TableModel tableModel) {
        this();
        setTableModel(tableModel);
    }

    public ExtendedTableSorterModel(TableModel tableModel, JTableHeader tableHeader) {
        this();
    ...
    private class TableModelHandler implements TableModelListener {
        public void tableChanged(TableModelEvent e) {
            ...
            if (e.getFirstRow() == e.getLastRow()
                ...
                fireTableChanged(new TableModelEvent(ExtendedTableSorterModel.this, 
                                                     viewIndex, viewIndex, 
                                                     column, e.getType()));
                return;
            }
