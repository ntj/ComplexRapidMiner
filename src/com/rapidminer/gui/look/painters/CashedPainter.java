 ...
 *
 * @author Ingo Mierswa
 * @version $Id: CashedPainter.java,v 1.3 2008/05/09 20:57:26 ingomierswa Exp $
 */
public class CashedPainter {
	...
	public static boolean drawButton(Component c, Graphics g) {
		...
		ButtonModel bm = ((AbstractButton) c).getModel();
		ButtonPainter.SINGLETON.paint(c, g, 0, 0, w, h, new Object[] { Boolean.valueOf(bm.isEnabled()), Boolean.valueOf(bm.isPressed()), Boolean.valueOf(bm.isSelected()) });
		return true;
	}
}
